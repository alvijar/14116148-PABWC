...
<body>
	...
	<div class="col-md-8">
		...
		<table class="table">
			...
			<tbody>
				...
				$sql = "SELECT artikel.id_artikel, artikel.artikel, user.nama FROM artikel, user WHERE artikel.id = user.id AND user.username LIKE '%$username%'";
	...
	<h4>TAMBAH DATA</h4>
		<form action="insert-pengguna.php" method="POST" enctype="multipart/form-data">
